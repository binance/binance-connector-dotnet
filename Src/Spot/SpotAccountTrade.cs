namespace Binance.Spot
{
    ...
    public class SpotAccountTrade : SpotService
    {
        ...
        /// </summary>
        /// <returns>OK.</returns>
        public async Task<string> TestNewOrder()
        {
        ...
        public async Task<string> NewOrder(string symbol, Side side, OrderType type, TimeInForce? timeInForce = null, decimal? quantity = null, decimal? quoteOrderQty = null, decimal? price = null, string newClientOrderId = null, decimal? stopPrice = null, decimal? icebergQty = null, NewOrderResponseType? newOrderRespType = null, long? recvWindow = null)
        {
            var result = await this.SendSignedAsync<string>(
                NEW_ORDER,
                HttpMethod.Post,
        ...
        public async Task<string> NewOco(string symbol, Side side, decimal quantity, decimal price, decimal stopPrice, string listClientOrderId = null, string limitClientOrderId = null, decimal? limitIcebergQty = null, string stopClientOrderId = null, decimal? stopLimitPrice = null, decimal? stopIcebergQty = null, TimeInForce? stopLimitTimeInForce = null, NewOrderResponseType? newOrderRespType = null, long? recvWindow = null)
        {
            var result = await this.SendSignedAsync<string>(
                NEW_OCO,
                HttpMethod.Post,
