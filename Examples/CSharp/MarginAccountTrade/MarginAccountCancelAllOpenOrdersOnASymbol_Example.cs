namespace Binance.Spot.MarginAccountTradeExamples
{
    ...
    public class MarginAccountCancelAllOpenOrdersOnASymbol_Example
    {
        public static async Task Main(string[] args)
        {
            ...
            ILogger logger = loggerFactory.CreateLogger<MarginAccountCancelAllOpenOrdersOnASymbol_Example>();
