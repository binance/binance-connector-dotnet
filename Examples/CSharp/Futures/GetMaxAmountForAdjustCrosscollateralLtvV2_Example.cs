namespace Binance.Spot.FuturesExamples
{
    ...
    public class GetMaxAmountForAdjustCrosscollateralLtvV2_Example
    {
        public static async Task Main(string[] args)
        {
            ...
            ILogger logger = loggerFactory.CreateLogger<GetMaxAmountForAdjustCrosscollateralLtvV2_Example>();
