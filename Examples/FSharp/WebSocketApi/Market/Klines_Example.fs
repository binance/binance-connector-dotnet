...
let main argv =
    ...
    websocket.Market.KlinesAsync(symbol = "BNBUSDT", interval = Interval.ONE_SECOND, limit = 10, cancellationToken = CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
