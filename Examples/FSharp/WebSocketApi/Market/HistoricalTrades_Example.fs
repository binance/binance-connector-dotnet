...
let main argv =
    ...
    let websocket = new WebSocketApi(apiKey = "apiKey");
    ...
    websocket.Market.HistoricalTradesAsync(symbol = "BNBUSDT", fromId = 0, limit = 123, cancellationToken = CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
