...
let main argv =
    ...
    websocket.Market.RollingWindowPriceChangeStatisticsAsync(symbol = null, symbols = symbols, windowSize = "1d", cancellationToken= CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
