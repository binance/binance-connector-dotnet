...
let main argv =
    ...
    websocket.Market.CurrentAveragePriceAsync(symbol = "BNBUSDT", requestId = 123, cancellationToken = CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
