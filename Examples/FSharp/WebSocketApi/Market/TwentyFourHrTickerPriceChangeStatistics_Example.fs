...
let main argv =
    ...
    websocket.Market.TwentyFourHrTickerPriceChangeStatisticsAsync(symbols = symbols, cancellationToken = CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
